...
const QString Messages::burnerMediaAvailability(const QString& burner_txt,
...
const QString Messages::burningErrorMessage(const QString& burn_process_error_message,
                                            int exit_code,
                                            int exit_status)
{
